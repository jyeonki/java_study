...
public class ListExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sList.toString()); // toString() 생략 가능
        ...
        sList.remove(1);
//        String s1 = sList.remove(2); // pop개념
        sList.remove("개굴이");
...
//        System.out.println(s1);
        ...
        // get(index) : 객체 참조
        String s2 = sList.get(2); // generic 타입이 String // sList에는 그대로 남아있음
