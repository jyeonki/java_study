...
//        } // 맞는지 확인하기
    ...
    public void insertMember(String id, String name, String password, String email, char gender, int age) {
        ...
        int count = existMemberNum(); // 현재 회원 수
        m[count] = new Member(id, name, password, email, gender, age); // 추가 할 회원
        // Member배열에는 Member만 들어갈 수 있다
    }
    ...
    public int findIndexById(String id) {
        int index = -1;
        for (int i = 0; i < existMemberNum(); i++) { // 회원이 있는만큼만 for문을 돌리겠다
