...
public class LocalDateExample {
    ...
    public static void main(String[] args) {
        ...
        int monthValue = localDateTime.getMonthValue(); // year = 2022
        System.out.println("monthValue = " + monthValue); // monthValue = 6
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy년 M월 d일 E요일 a h시 m분");
