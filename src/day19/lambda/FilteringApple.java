...
public class FilteringApple {
    ...
    /**
     * @solution try 2 - 색을 파라미터화 한다
     * @problem
     * - 만약 필터기준이 색상이 아니라 무게라면??
     * - 무게 파라미터를 가진 메서트 filterApplesByWeight 만들건가?
     * - 만약 필터기준이 색상 + 무게
     * - 어차미 조건문 빼고 코드가 똑같을 것 같은데?
     */
     ...
     *
     * @problem - 필터 조건별 클래스가 너무 많아진다. 익명클래스로 해결하면 된다.
     *
     */
    // solution a
    ...
    // solution b - 사과 무게가 100g보다 큰지 확인
